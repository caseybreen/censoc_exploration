...
df$bpl_cat[df$BPL>09900] <- 2 #"Foreigners"
...
tab_df$bpl_label[tab_df$bpl_cat==2] <- "Rest of the world"
...
__NOTE:  Model run time can be quite long. In this case, for 10,000 iterations it could take 5 minutes using 2 place of birth categories. However, increasing the number of iterations or the categories, increases the run time.__
