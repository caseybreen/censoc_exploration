...
df$bpl_cat[df$BPL >= 45600 & df$BPL <= 46500  ] <-2 #Russian Empire (includes Estonia, Latvia, Lituania, Baltic States and Other USSR/"Russia")
...
tab_df$bpl_label[tab_df$bpl_cat==2] <- "Russia"
